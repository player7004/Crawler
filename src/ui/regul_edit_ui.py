...
################################################################################
## Form generated from reading UI file 'regulcoCGxJ.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_2.addWidget(self.bt_cancel, 0, 3, 1, 1)

        self.bt_del = QPushButton(self.gridLayoutWidget_2)
        self.bt_del.setObjectName(u"bt_del")

        self.gridLayout_2.addWidget(self.bt_del, 2, 3, 1, 1)
